...
def cargar_data_csv(file_path: str) -> pd.DataFrame:
    ...
    columna_fecha : str
        Nombre de la columna con valores de fecha (de tipo datetime).
    columna_puntos1 : str
        Nombre de la primera columna numérica a graficar.
    columna_puntos2 : str
        Nombre de la segunda columna numérica a graficar.

    Retorna
    -------
    matplotlib.figure.Figure
        Figura con los tres gráficos embebidos.
    """
